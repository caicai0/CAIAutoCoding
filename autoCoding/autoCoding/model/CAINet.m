...
- (AFHTTPRequestOperation *)get:(NSString *)urlString parameters:(NSDictionary *)paramters finish:(void(^)(NSDictionary *responsObject , NSError *error)) finish{
...
- (AFHTTPRequestOperation *)post:(NSString *)urlString parameters:(NSDictionary *)paramters finish:(void(^)(NSDictionary *responsObject , NSError *error)) finish{
    urlString = [self fullUrlStringWithUrlString:urlString];
    NSError * error = nil;
    NSMutableURLRequest * request = [[AFHTTPRequestSerializer serializer]requestWithMethod:@"POST" URLString:urlString parameters:paramters error:&error];

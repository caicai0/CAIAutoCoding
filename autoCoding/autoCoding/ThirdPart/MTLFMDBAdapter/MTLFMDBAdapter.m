...
+ (NSString *)findStatementInQuerys:(NSArray *)querys orderByArray:(NSArray *)orderArray inTable:(NSString *)tableName{
    ...
    if (querys && querys.count) {
        ...
        statement = [NSString stringWithFormat:@"where %@",[stats componentsJoinedByString:@" AND "]];
    }
    return [self findStatementInWhereString:statement orderByArray:orderArray inTable:tableName];
}

+ (NSString *)findStatementInWhereString:(NSString *)whereString orderByArray:(NSArray *)orderArray inTable:(NSString *)tableName{
    ...
    if(tableName && [tableName isKindOfClass:[NSString class]]){
        ...
        if (whereString && [whereString isKindOfClass:[NSString class]]) {
            statement = [statement stringByAppendingString:whereString];
        }
...
+ (NSString *)deleteStatementInQuerys:(NSArray *)querys inTable:(NSString *)tableName{
    NSParameterAssert(tableName);
